...
public class TextBox {
	...
	private int textXOffset, textXStart, maxTextWidth;
	...
	public TextBox(int type, int x, int y) {
		...
		this.x = x;
		this.y = y;
		this.font = LoadSave.getGameFont(Font.BOLD, maxFontSize);
		this.textXOffset = 48;
		this.textXStart = x + textXOffset;
		this.bounds = new Rectangle(x, y, (int) ImageLoader.textBoxBg[type].getWidth(),
				(int) ImageLoader.textBoxBg[type].getHeight());
		this.maxTextWidth = bounds.width - textXOffset * 2;
	}
	...
	public void render(Graphics g) {
		...
		g.setFont(font);
		RenderText.renderText(g, text, RenderText.LEFT, textXStart, y, bounds.width - textXOffset * 2, bounds.height);
