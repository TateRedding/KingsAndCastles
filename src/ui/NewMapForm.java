...
public class NewMapForm extends Overlay {
	...
	public void render(Graphics g) {
		super.render(g);
		g.setFont(LoadSave.getGameFont(Font.BOLD, 40f));
		...
		RenderText.renderText(g, "Map Name", RenderText.CENTER, x, y + (int) rowHeight, width, (int) rowHeight);
		RenderText.renderText(g, "Tile Width", RenderText.CENTER, x + (int) columnWidth, y + (int) rowHeight * 4,
				(int) columnWidth, (int) rowHeight);
		RenderText.renderText(g, "Tile Height", RenderText.CENTER, x + (int) columnWidth * 3, y + (int) rowHeight * 4,
				(int) columnWidth, (int) rowHeight);
		
		g.setFont(LoadSave.getGameFont(Font.BOLD, 20f));
		RenderText.renderText(g, widthBounds, RenderText.CENTER, x + (int) columnWidth, y + (int) rowHeight * 6,
				(int) columnWidth, (int) rowHeight);
		RenderText.renderText(g, heightBounds, RenderText.CENTER, x + (int) columnWidth * 3, y + (int) rowHeight * 6,
				(int) columnWidth, (int) rowHeight);
		for (TextBox tb : textBoxes)
			tb.render(g);
	}
