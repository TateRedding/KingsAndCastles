...
public abstract class MapState extends State implements StateMethods {
	...
	public MapState(Game game, Map map) {
		...
		maxXTileOffset = map.getTileData()[0].length - GAME_AREA_TILE_WIDTH;
		maxYTileOffset = map.getTileData().length - GAME_AREA_TILE_HEIGHT;
		gameBounds = new Rectangle(0, TopBar.TOP_BAR_HEIGHT, Game.GAME_AREA_WIDTH, Game.GAME_AREA_HEIGHT);
	}
